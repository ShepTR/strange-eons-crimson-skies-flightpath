...
function create( diy ) {
	...
	diy.name = #cs-huge-ship;
	$Affiliation = #cs-huge-affiliation;
	$PilotSkill = #cs-huge-ps;
		
	$ForeText = #cs-huge-fore-text;
	$ForeTextFlavor =  #cs-huge-fore-text-flavor;
	$ForeCrippledText = #cs-huge-fore-crippled-text;
	$ForeCrippledTextFlavor =  #cs-huge-fore-crippled-text-flavor;
	$ForePwv = #cs-huge-fore-pwv;
	$ForeCrippledPwv = #cs-huge-fore-crippled-pwv;
	$ForeRange = #cs-huge-fore-range;
	$ForeCrippledRange = #cs-huge-fore-crippled-range;
	$ForeArc = #cs-huge-fore-arc;
	$ForeTurret = #cs-huge-fore-turret;
	$ForeEnergy = #cs-huge-fore-energy;
	$ForeCrippledEnergy = #cs-huge-fore-crippled-energy;
	$ForeHull = #cs-huge-fore-hull;
	$ForeShield = #cs-huge-fore-shield;
	$ForeRecoverAction = #cs-huge-fore-recover;
	$ForeReinforceAction = #cs-huge-fore-reinforce;
	$ForeCoordinateAction = #cs-huge-fore-coordinate;
	$ForeJamAction = #cs-huge-fore-jam;
	$ForeLockAction = #cs-huge-fore-lock;
	$ForeUpgrade1 = #cs-huge-fore-upgrade-1;
	$ForeUpgrade2 = #cs-huge-fore-upgrade-2;
	$ForeUpgrade3 = #cs-huge-fore-upgrade-3;
	$ForeUpgrade4 = #cs-huge-fore-upgrade-4;
	$ForeUpgrade5 = #cs-huge-fore-upgrade-5;
	$ForeUpgrade6 = #cs-huge-fore-upgrade-6;
	$ForeUpgrade7 = #cs-huge-fore-upgrade-7;
	$ForeCrippledUpgrade1 = #cs-huge-fore-crippled-upgrade-1;
	$ForeCrippledUpgrade2 = #cs-huge-fore-crippled-upgrade-2;
	$ForeCrippledUpgrade3 = #cs-huge-fore-crippled-upgrade-3;
	$ForeCrippledUpgrade4 = #cs-huge-fore-crippled-upgrade-4;
	$ForeCrippledUpgrade5 = #cs-huge-fore-crippled-upgrade-5;
	$ForeCrippledUpgrade6 = #cs-huge-fore-crippled-upgrade-6;
	$ForeCrippledUpgrade7 = #cs-huge-fore-crippled-upgrade-7;
	$ForeCost = #cs-huge-fore-cost;
	
	$AftText = #cs-huge-aft-text;
	$AftTextFlavor = #cs-huge-aft-text-flavor;
	$AftCrippledText = #cs-huge-aft-crippled-text;
	$AftCrippledTextFlavor = #cs-huge-aft-crippled-text-flavor;
	$AftPwv = #cs-huge-aft-pwv;
	$AftCrippledPwv = #cs-huge-aft-crippled-pwv;
	$AftRange = #cs-huge-aft-range;
	$AftCrippledRange = #cs-huge-aft-crippled-range;
	$AftArc = #cs-huge-aft-arc;
	$AftTurret = #cs-huge-aft-turret;
	$AftEnergy = #cs-huge-aft-energy;
	$AftCrippledEnergy = #cs-huge-aft-crippled-energy;
	$AftHull = #cs-huge-aft-hull;
	$AftShield = #cs-huge-aft-shield;
	$AftRecoverAction = #cs-huge-aft-recover;
	$AftReinforceAction = #cs-huge-aft-reinforce;
	$AftCoordinateAction = #cs-huge-aft-coordinate;
	$AftJamAction = #cs-huge-aft-jam;
	$AftLockAction = #cs-huge-aft-lock;
	$AftUpgrade1 = #cs-huge-aft-upgrade-1;
	$AftUpgrade2 = #cs-huge-aft-upgrade-2;
	$AftUpgrade3 = #cs-huge-aft-upgrade-3;
	$AftUpgrade4 = #cs-huge-aft-upgrade-4;
	$AftUpgrade5 = #cs-huge-aft-upgrade-5;
	$AftUpgrade6 = #cs-huge-aft-upgrade-6;
	$AftUpgrade7 = #cs-huge-aft-upgrade-7;
	$AftCrippledUpgrade1 = #cs-huge-aft-crippled-upgrade-1;
	$AftCrippledUpgrade2 = #cs-huge-aft-crippled-upgrade-2;
	$AftCrippledUpgrade3 = #cs-huge-aft-crippled-upgrade-3;
	$AftCrippledUpgrade4 = #cs-huge-aft-crippled-upgrade-4;
	$AftCrippledUpgrade5 = #cs-huge-aft-crippled-upgrade-5;
	$AftCrippledUpgrade6 = #cs-huge-aft-crippled-upgrade-6;
	$AftCrippledUpgrade7 = #cs-huge-aft-crippled-upgrade-7;
	$AftCost = #cs-huge-aft-cost;
	
	$Location = #cs-huge-location;
	$DoubleSection = #cs-huge-double;
}
...
function createInterface( diy, editor ) {
	...
	doubleCheckbox = checkBox( @cs-double-sections );
	bindings.add( 'DoubleSection', doubleCheckbox, [0,1,2,3,4,5] );

	locationItems = [];
	locationItems[0] = ListItem( 'attack-energy', @cs-location-attack-energy );
	locationItems[1] = ListItem( 'energy-attack', @cs-location-energy-attack );
	locationItems[2] = ListItem( 'none-energy', @cs-location-none-energy );
	locationItems[3] = ListItem( 'energy-none', @cs-location-energy-none );
	...
	iconCardPanel.panelTitle = @cs-icon-card;	
	
	iconTokenPanel = portraitPanel( diy, 5 );
	iconTokenPanel.setParentPanel( iconCardPanel );		
	iconTokenPanel.panelTitle = @cs-icon-token;

	commonPanel = new Grid( '', '[min:pref][min:pref,grow][min:pref][min:pref,grow]', '');
	commonPanel.setTitle( @cs-info );
	commonPanel.place( @cs-affiliation, '', affiliationBox, 'growx, wrap' );	
	commonPanel.place( @cs-ship, '', nameField, 'span, growx, wrap' );
	commonPanel.place( doubleCheckbox, 'span, wrap para' );
	commonPanel.place( @cs-location, '', locationBox, 'growx, wrap' );	
	commonPanel.place( @cs-ps, '', psBox, 'wmin 52, wrap' );
	...
	foreTextFlavor = checkBox( @cs-text-flavor );
	...
	foreCrippledTextFlavor = checkBox( @cs-text-flavor );
	...
	foreArcItems[1] = ListItem( 'broadside', @cs-arc-broadside );
	foreArcItems[2] = ListItem( 'extendedBroadside', @cs-arc-extended-broadside );
	foreArcItems[3] = ListItem( 'front', @cs-arc-front );
	foreArcItems[4] = ListItem( 'extendedFront', @cs-arc-extended-front );
	foreArcItems[5] = ListItem( 'fullArc', @cs-arc-full );
	foreArcBox = comboBox( foreArcItems );
	bindings.add( 'ForeArc', foreArcBox, [4] );

	foreTurret = checkBox( @cs-turret );
	...
	foreRecoverCheckbox = checkBox( @cs-action-recover );
	bindings.add( 'ForeRecoverAction', foreRecoverCheckbox, [0,4] );
	foreReinforceCheckbox = checkBox( @cs-action-reinforce );
	bindings.add( 'ForeReinforceAction', foreReinforceCheckbox, [0,4] );
	foreCoordinateCheckbox = checkBox( @cs-action-coordinate );
	bindings.add( 'ForeCoordinateAction', foreCoordinateCheckbox, [0,4] );
	foreJamCheckbox = checkBox( @cs-action-jam );
	bindings.add( 'ForeJamAction', foreJamCheckbox, [0,4] );
	foreLockCheckbox = checkBox( @cs-action-lock );
	...
	upgradeItems[6] = ListItem( 'illicit', @cs-upgrade-illicit );
	upgradeItems[7] = ListItem( 'bomb', @cs-upgrade-bomb );
	upgradeItems[8] = ListItem( 'crew', @cs-upgrade-crew );
	upgradeItems[9] = ListItem( 'hardpoint', @cs-upgrade-hardpoint );
	upgradeItems[10] = ListItem( 'team', @cs-upgrade-team );
	upgradeItems[11] = ListItem( 'cargo', @cs-upgrade-cargo );
	...
	forePanel.setTitle( @cs-info );
	forePanel.place( @cs-text, 'span 2', foreTextFlavor, 'wrap' );
	forePanel.place( foreTextArea, 'span, grow, wrap para' );
	forePanel.place( @cs-crippledtext, 'span 2', foreCrippledTextFlavor, 'wrap');
	...
	forePanel.place( @cs-arc, '', foreArcBox, 'wmin 100, span 2, wrap' );
	forePanel.place( foreTurret, 'wrap' );
	forePanel.place( @cs-pwv, '', forePwvBox, 'wmin 52', @cs-range, '', foreRangeBox, 'wmin 70, wrap' );
	forePanel.place( @cs-crippledpwv, '', foreCrippledPwvBox, 'wmin 52', @cs-range, '', foreCrippledRangeBox, 'wmin 70, wrap' );
	forePanel.place( @cs-energy, '', foreEnergyBox, 'wmin 52, wrap' );
	forePanel.place( @cs-crippledenergy, '', foreCrippledEnergyBox, 'wmin 52, wrap' );
	forePanel.place( @cs-hull, '', foreHullBox, 'wmin 52, wrap' );
	forePanel.place( @cs-shield, '', foreShieldBox, 'wmin 52, wrap para' );
	forePanel.place( separator(), 'span, growx, wrap para' );
	forePanel.place( @cs-actions, 'wrap' );
	...
	forePanel.place( separator(), 'span, growx, wrap para' );
	forePanel.place( @cs-upgrades, 'wmin 100',  @cs-upgrades-crippled, 'wrap' );
	...
	forePanel.place( separator(), 'span, growx, wrap para' );
	forePanel.place( @cs-cost, 'span 2', foreCostBox, 'wmin 100, wrap para' );
	forePanel.place( separator(), 'span, growx, wrap para' );
	...
	aftTextFlavor = checkBox( @cs-text-flavor );
	...
	aftCrippledTextFlavor = checkBox( @cs-text-flavor );
	bindings.add( 'AftCrippledTextFlavor', aftCrippledTextFlavor, [3] );
	
	specialSymbolsTip2 = tipButton( @cs-text-tooltip );

	aftArcItems = [];
	aftArcItems[0] = ListItem( '-', '-' );
	aftArcItems[1] = ListItem( 'broadside', @cs-arc-broadside );
	aftArcItems[2] = ListItem( 'extendedBroadside', @cs-arc-extended-broadside );
	aftArcItems[3] = ListItem( 'rear', @cs-arc-rear );
	aftArcItems[4] = ListItem( 'extendedRear', @cs-arc-extended-rear );
	aftArcItems[5] = ListItem( 'fullArc', @cs-arc-full );
	aftArcBox = comboBox( aftArcItems );
	bindings.add( 'AftArc', aftArcBox, [4] );

	aftTurret = checkBox( @cs-turret );
	...
	aftRecoverCheckbox = checkBox( @cs-action-recover );
	bindings.add( 'AftRecoverAction', aftRecoverCheckbox, [2,4] );
	aftReinforceCheckbox = checkBox( @cs-action-reinforce );
	bindings.add( 'AftReinforceAction', aftReinforceCheckbox, [2,4] );
	aftCoordinateCheckbox = checkBox( @cs-action-coordinate );
	bindings.add( 'AftCoordinateAction', aftCoordinateCheckbox, [2,4] );
	aftJamCheckbox = checkBox( @cs-action-jam );
	bindings.add( 'AftJamAction', aftJamCheckbox, [2,4] );
	aftLockCheckbox = checkBox( @cs-action-lock );
	...
	aftPanel.setTitle( @cs-info );
	aftPanel.place( @cs-text, 'span 2', aftTextFlavor, 'wrap' );
	aftPanel.place( aftTextArea, 'span, grow, wrap para' );
	aftPanel.place( @cs-crippledtext, 'span 2', aftCrippledTextFlavor, 'wrap');
	...
	aftPanel.place( @cs-arc, '', aftArcBox, 'wmin 100, span 2, wrap' );
	aftPanel.place( aftTurret, 'wrap' );
	aftPanel.place( @cs-pwv, '', aftPwvBox, 'wmin 52', @cs-range, '', aftRangeBox, 'wmin 70, wrap' );
	aftPanel.place( @cs-crippledpwv, '', aftCrippledPwvBox, 'wmin 52', @cs-range, '', aftCrippledRangeBox, 'wmin 70, wrap' );
	aftPanel.place( @cs-energy, '', aftEnergyBox, 'wmin 52, wrap' );
	aftPanel.place( @cs-crippledenergy, '', aftCrippledEnergyBox, 'wmin 52, wrap' );
	aftPanel.place( @cs-hull, '', aftHullBox, 'wmin 52, wrap' );
	aftPanel.place( @cs-shield, '', aftShieldBox, 'wmin 52, wrap para' );
	aftPanel.place( separator(), 'span, growx, wrap para' );
	aftPanel.place( @cs-actions, 'wrap' );
	...
	aftPanel.place( separator(), 'span, growx, wrap para' );
	aftPanel.place( @cs-upgrades, 'wmin 100',  @cs-upgrades-crippled, 'wrap' );
	...
	aftPanel.place( separator(), 'span, growx, wrap para' );
	aftPanel.place( @cs-cost, 'span 2', aftCostBox, 'wmin 100, wrap para' );
	aftPanel.place( separator(), 'span, growx, wrap para' );
	...
	commonPanel.addToEditor( editor, @cs-common, null, null, 0 );
	forePanel.addToEditor( editor, @cs-fore, null, null, 1 );
	aftPanel.addToEditor( editor, @cs-aft, null, null, 2 );

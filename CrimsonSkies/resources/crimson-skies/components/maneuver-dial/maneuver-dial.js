...
function createInterface( diy, editor ) {
	...
	maneuverTip = tipButton( @cs-maneuver-tooltip );

	hugeCheckbox = checkBox( @cs-huge );
	bindings.add( 'Huge', hugeCheckbox, [2] );

	straightItems = [];
	straightItems[0] = ListItem( 'na', '-' );
	straightItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-straight.png' ), 18 ) );
	straightItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-straight.png' ), 18 ) );
	straightItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-straight.png' ), 18 ) );

	kTurnItems = [];
	kTurnItems[0] = ListItem( 'na', '-' );
	kTurnItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-k-turn.png' ), 18 ) );
	kTurnItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-k-turn.png' ), 18 ) );
	kTurnItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-k-turn.png' ), 18 ) );

	leftTurnItems = [];
	leftTurnItems[0] = ListItem( 'na', '-' );
	leftTurnItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-left-turn.png' ), 18 ) );
	leftTurnItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-turn.png' ), 18 ) );
	leftTurnItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-left-turn.png' ), 18 ) );

	rightTurnItems = [];
	rightTurnItems[0] = ListItem( 'na', '-' );
	rightTurnItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-right-turn.png' ), 18 ) );
	rightTurnItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-turn.png' ), 18 ) );
	rightTurnItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-right-turn.png' ), 18 ) );

	leftBankItems = [];
	leftBankItems[0] = ListItem( 'na', '-' );
	leftBankItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-left-bank.png' ), 18 ) );
	leftBankItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-bank.png' ), 18 ) );
	leftBankItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-left-bank.png' ), 18 ) );

	rightBankItems = [];
	rightBankItems[0] = ListItem( 'na', '-' );
	rightBankItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-right-bank.png' ), 18 ) );
	rightBankItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	rightBankItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-right-bank.png' ), 18 ) );

	leftLoopItems = [];
	leftLoopItems[0] = ListItem( 'na', '-' );
	leftLoopItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-left-loop.png' ), 18 ) );
	leftLoopItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-loop.png' ), 18 ) );
	leftLoopItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-left-loop.png' ), 18 ) );

	rightLoopItems = [];
	rightLoopItems[0] = ListItem( 'na', '-' );
	rightLoopItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-right-loop.png' ), 18 ) );
	rightLoopItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-loop.png' ), 18 ) );
	rightLoopItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-right-loop.png' ), 18 ) );

	leftRollItems = [];
	leftRollItems[0] = ListItem( 'na', '-' );
	leftRollItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-left-roll.png' ), 18 ) );
	leftRollItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-roll.png' ), 18 ) );
	leftRollItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-left-roll.png' ), 18 ) );

	rightRollItems = [];
	rightRollItems[0] = ListItem( 'na', '-' );
	rightRollItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-right-roll.png' ), 18 ) );
	rightRollItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-roll.png' ), 18 ) );
	rightRollItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-right-roll.png' ), 18 ) );

    // CS Maneuvers - Curve

    leftCurveItems = [];
	leftCurveItems[0] = ListItem( 'na', '-' );
	leftCurveItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-left-curve.png' ), 18 ) );
	leftCurveItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-curve.png' ), 18 ) );
	leftCurveItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-left-curve.png' ), 18 ) );

    rightCurveItems = [];
	rightCurveItems[0] = ListItem( 'na', '-' );
	rightCurveItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-right-curve.png' ), 18 ) );
	rightCurveItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-curve.png' ), 18 ) );
	rightCurveItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-right-curve.png' ), 18 ) );
  
    // CS Maneuvers - Powerslide
     
    leftPowerslideItems = [];
	leftPowerslideItems[0] = ListItem( 'na', '-' );
	leftPowerslideItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-left-powerslide.png' ), 18 ) );
	leftPowerslideItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-powerslide.png' ), 18 ) );
	leftPowerslideItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-left-powerslide.png' ), 18 ) );

    rightPowerslideItems = [];
	rightPowerslideItems[0] = ListItem( 'na', '-' );
	rightPowerslideItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-right-powerslide.png' ), 18 ) );
	rightPowerslideItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-powerslide.png' ), 18 ) );
	rightPowerslideItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-right-powerslide.png' ), 18 ) );

    // CS Maneuvers - Slide

    leftSlideItems = [];
	leftSlideItems[0] = ListItem( 'na', '-' );
	leftSlideItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-left-slide.png' ), 18 ) );
	leftSlideItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-slide.png' ), 18 ) );
	leftSlideItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-left-slide.png' ), 18 ) );

    rightSlideItems = [];
	rightSlideItems[0] = ListItem( 'na', '-' );
	rightSlideItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-right-slide.png' ), 18 ) );
	rightSlideItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-slide.png' ), 18 ) );
	rightSlideItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-right-slide.png' ), 18 ) );
	
	// CS Maneuvers - Rollout
	
	leftRolloutItems = [];
	leftRolloutItems[0] = ListItem( 'na', '-' );
	leftRolloutItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-left-out.png' ), 18 ) );
	leftRolloutItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-out.png' ), 18 ) );
	leftRolloutItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-left-out.png' ), 18 ) );

    rightRolloutItems = [];
	rightRolloutItems[0] = ListItem( 'na', '-' );
	rightRolloutItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-right-out.png' ), 18 ) );
	rightRolloutItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-out.png' ), 18 ) );
	rightRolloutItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-right-out.png' ), 18 ) );
	
	stationaryItems = [];
	stationaryItems[0] = ListItem( 'na', '-' );
	stationaryItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/green-stationary.png' ), 18 ) );
	stationaryItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	stationaryItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/red-stationary.png' ), 18 ) );
	...
	maneuverBoxLC3 = comboBox( leftCurveItems );
	bindings.add( 'ManeuverLC3', maneuverBoxLC3, [2] );
	
	maneuverBoxRC3 = comboBox( rightCurveItems );
	bindings.add( 'ManeuverRC3', maneuverBoxRC3, [2] );
	
	maneuverBoxLP3 = comboBox( leftPowerslideItems );
	bindings.add( 'ManeuverLP3', maneuverBoxLP3, [2] );

	maneuverBoxRP3 = comboBox( rightPowerslideItems );
	bindings.add( 'ManeuverRP3', maneuverBoxRP3, [2] );
		
	maneuverBoxLS3 = comboBox( leftSlideItems );
	bindings.add( 'ManeuverLC3', maneuverBoxLS3, [2] );

	maneuverBoxRS3 = comboBox( rightSlideItems );
	bindings.add( 'ManeuverRC3', maneuverBoxRS3, [2] );
	
	maneuverBoxLO3 = comboBox( leftRolloutItems );
	bindings.add( 'ManeuverLO3', maneuverBoxLO3, [2] );

	maneuverBoxRO3 = comboBox( rightRolloutItems );
	bindings.add( 'ManeuverRO3', maneuverBoxRO3, [2] );
	...
	//
		...
		maneuverBoxLC2 = comboBox( leftCurveItems );
	bindings.add( 'ManeuverLC2', maneuverBoxLC2, [2] );
	
	maneuverBoxRC2 = comboBox( rightCurveItems );
	bindings.add( 'ManeuverRC2', maneuverBoxRC2, [2] );
	
	maneuverBoxLP2 = comboBox( leftPowerslideItems );
	bindings.add( 'ManeuverLP2', maneuverBoxLP2, [2] );

	maneuverBoxRP2 = comboBox( rightPowerslideItems );
	bindings.add( 'ManeuverRP2', maneuverBoxRP2, [2] );
		
	maneuverBoxLS2 = comboBox( leftSlideItems );
	bindings.add( 'ManeuverLC2', maneuverBoxLS2, [2] );

	maneuverBoxRS2 = comboBox( rightSlideItems );
	bindings.add( 'ManeuverRC2', maneuverBoxRS2, [2] );
	
	maneuverBoxLO2 = comboBox( leftRolloutItems );
	bindings.add( 'ManeuverLO2', maneuverBoxLO2, [2] );

	maneuverBoxRO2 = comboBox( rightRolloutItems );
	bindings.add( 'ManeuverRO2', maneuverBoxRO2, [2] );
	...
	maneuverBoxLC1 = comboBox( leftCurveItems );
	bindings.add( 'ManeuverLC1', maneuverBoxLC1, [2] );
	
	maneuverBoxRC1 = comboBox( rightCurveItems );
	bindings.add( 'ManeuverRC1', maneuverBoxRC1, [2] );
	
	maneuverBoxLP1 = comboBox( leftPowerslideItems );
	bindings.add( 'ManeuverLP1', maneuverBoxLP1, [2] );

	maneuverBoxRP1 = comboBox( rightPowerslideItems );
	bindings.add( 'ManeuverRP1', maneuverBoxRP1, [2] );
		
	maneuverBoxLS1 = comboBox( leftSlideItems );
	bindings.add( 'ManeuverLC1', maneuverBoxLS1, [2] );

	maneuverBoxRS1 = comboBox( rightSlideItems );
	bindings.add( 'ManeuverRC1', maneuverBoxRS1, [2] );
	
	maneuverBoxLO1 = comboBox( leftRolloutItems );
	bindings.add( 'ManeuverLO1', maneuverBoxLO1, [2] );

	maneuverBoxRO1 = comboBox( rightRolloutItems );
	bindings.add( 'ManeuverRO1', maneuverBoxRO1, [2] );
	...
	hugeStraightItems[1] = ListItem( '0', '0', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-straight.png' ), 18 ) );
	hugeStraightItems[2] = ListItem( '1', '1', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-straight.png' ), 18 ) );
	hugeStraightItems[3] = ListItem( '2', '2', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-straight.png' ), 18 ) );
	hugeStraightItems[4] = ListItem( '3', '3', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-straight.png' ), 18 ) );
	hugeStraightItems[5] = ListItem( '4', '4', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-straight.png' ), 18 ) );
	hugeStraightItems[6] = ListItem( '5', '5', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-straight.png' ), 18 ) );

	hugeLeftItems = [];
	hugeLeftItems[0] = ListItem( 'na', '-' );
	hugeLeftItems[1] = ListItem( '0', '0', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-bank.png' ), 18 ) );
	hugeLeftItems[2] = ListItem( '1', '1', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-bank.png' ), 18 ) );
	hugeLeftItems[3] = ListItem( '2', '2', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-bank.png' ), 18 ) );
	hugeLeftItems[4] = ListItem( '3', '3', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-bank.png' ), 18 ) );
	hugeLeftItems[5] = ListItem( '4', '4', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-bank.png' ), 18 ) );
	hugeLeftItems[6] = ListItem( '5', '5', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-left-bank.png' ), 18 ) );

	hugeRightItems = [];
	hugeRightItems[0] = ListItem( 'na', '-' );
	hugeRightItems[1] = ListItem( '0', '0', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	hugeRightItems[2] = ListItem( '1', '1', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	hugeRightItems[3] = ListItem( '2', '2', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	hugeRightItems[4] = ListItem( '3', '3', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	hugeRightItems[5] = ListItem( '4', '4', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	hugeRightItems[6] = ListItem( '5', '5', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	
	hugeStationaryItems = [];
	hugeStationaryItems[0] = ListItem( 'na', '-' );
	hugeStationaryItems[1] = ListItem( '0', '0', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	hugeStationaryItems[2] = ListItem( '1', '1', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	hugeStationaryItems[3] = ListItem( '2', '2', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	hugeStationaryItems[4] = ListItem( '3', '3', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	hugeStationaryItems[5] = ListItem( '4', '4', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	hugeStationaryItems[6] = ListItem( '5', '5', ImageUtils.createIcon( ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	...
	mainPanel.place( @cs-affiliation, '', affiliationBox, 'span, growx, wrap' );	
	mainPanel.place( @cs-ship, '', nameField, 'span, growx, wrap' );
	...
	mainPanel.place( @cs-maneuver-speed-0, '', '', '', '', '', '', '', '', '', maneuverBox0, '', '', '', '', '', '', '', '', 'wrap para' );
	mainPanel.place( separator(), 'span, growx, wrap para' );
	mainPanel.place( @cs-huge-maneuvers, 'span 4, wrap' );
	mainPanel.place( @cs-maneuver-speed-4, '', '', 'span 2', hugeManeuverBoxS4, 'span 2, wmin 80, wrap' );
	mainPanel.place( @cs-maneuver-speed-3, '', '', 'span 2', hugeManeuverBoxS3, 'span 2, wmin 80, wrap' );
	mainPanel.place( @cs-maneuver-speed-2, '', hugeManeuverBoxL2, 'span 2, wmin 80', hugeManeuverBoxS2, 'span 2, wmin 80', hugeManeuverBoxR2, 'span 2, wmin 80, wrap' );
	mainPanel.place( @cs-maneuver-speed-1, '', hugeManeuverBoxL1, 'span 2, wmin 80', hugeManeuverBoxS1, 'span 2, wmin 80', hugeManeuverBoxR1, 'span 2, wmin 80, wrap' );	
	mainPanel.place( @cs-maneuver-speed-0, '', '', 'span 2', hugeManeuverBox0, 'span 2, wmin 80', '', 'wrap' );	
...
function paintFront( g, diy, sheet ) {
	if( sheet.sheetIndex == 0 ) {
		...
		for( let i=0; i<maneuverArray.length; ++i ) {
			...
			bearingImage = ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/' + temp[0] + '.png' );
			speedImage = ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/' + temp[1] + '.png' );
			if( $$Huge.yesNo ) {
				energyImage = ImageUtils.get( 'crimson-skies/components/maneuver-dial/images/' + temp[2] + '.png' );
				bearingScale = 0.26;
				speedScale = 0.24;
				energyScale = 0.5;
			} else {

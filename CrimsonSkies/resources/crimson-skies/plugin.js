...
function initialize() {
	...
	try {
		...
		Language.getInterface().addStrings( 'crimson-skies/text/ui' );
		Language.getInterface().addStrings( 'crimson-skies/text/common' );
		...
		Game.get( 'CS' ).masterSettings.addSettingsFrom( 'crimson-skies/base.settings' );
				
		ClassMap.add( 'crimson-skies/base.classmap' );

	} catch( ex ) {
		Eons.log.severe( 'CrimsonSkies plug-in failed to start' );

...
var settings;
var cskiesGame = Game.get( 'CS' );
if( cskiesGame != null ) {
	settings = cskiesGame.masterSettings;
} else {
	settings = Settings.shared;
}
settings.addSettingsFrom( 'crimson-skies/base.settings' );
...
useLibrary( 'project:CrimsonSkies/resources/crimson-skies/namedobj.js' );
...
var projBase = 'project:CrimsonSkies/resources/crimson-skies/text/';
